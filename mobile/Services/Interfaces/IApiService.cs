...
namespace AudioGo.Services.Interfaces
{
    public interface IApiService
    {
        ...
        /// <summary>Lấy lịch sử nghe gần nhất của thiết bị từ server. Trả null nếu lỗi network.</summary>
        Task<List<ListenHistoryItemDto>?> GetListenHistoryAsync(string deviceId, string lang = "vi", int limit = 5, CancellationToken ct = default);
