                  ...
                  <>
                    ...
                    <div className="grid grid-cols-2 gap-3 pt-4 border-t border-gray-50">
                      <button
                        ...
                        title={plan.isActive ? "Bấm để ẩn gói VIP này với người dùng" : "Bấm để kích hoạt hiển thị gói VIP này"}
                      ...
                      <button
                        ...
                        title="Chỉnh sửa thông tin gói đăng ký"
                    ...
                    {!plan.isActive && (
                      <button
                        ...
                        title="Xóa gói đăng ký này khỏi hệ thống"
